...
A while ago I co-held a Contiki bootcamp. My part consisted mainly of showing the Contiki serial shell, the network simulator Cooja, the Mobility and some debugging features. This post will go through those topics in the same order. This will be a long post... :)
...
Either start a new simulation (Ctrl + S) or add more motes to the already existing one. Create a total of <strong>three</strong> nodes with <code><a title=\"broadcaster.c source code\" href=\"http://www.bithappens.se/random/contiki-debugging/broadcaster.c\">broadcaster.c</a></code> and <strong>seven</strong> with <code><a title=\"silent.c source code\" href=\"http://www.bithappens.se/random/contiki-debugging/silent.c\">silent.c</a></code>.
...
<ul>
	<li>Put the mobility folder under your cooja/apps/ (eg contiki-2.x/tools/cooja/apps/mobility)</li>
	<li>Start COOJA</li>
