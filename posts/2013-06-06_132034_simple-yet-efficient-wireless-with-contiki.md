...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/cooja/0-SimpleRDC-Cooja-two-nodes-w-unicast-reject-and-ACK.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/cooja/1-SimpleRDC-Cooja-broadcast.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/cooja/2-SimpleRDC-Cooja-unicast-zoom-in,ACK-on-rcv.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/cooja/4-SimpleRDC-Cooja-lucky-unicast.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/logic/1-SimpleRDC-periodic-tx,channel-samples,toggling-LED.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/logic/2-SimpleRDC-sending-a-broadcast-with-CSMA,channel-sample-before-and-after.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/logic/3-SimpleRDC-sending-an-unicast.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/logic/4-SimpleRDC-BWU-channel-sample,4ms,and-a-unicast-rx+ACK.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/logic/5-SimpleRDC-one-polling-channel-sample.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/logic/6-SimpleRDC-zoom-in-on-a-transmission-go-idle,load-fifo,tx.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/1-some-channel-sample-period-mcu-wake-up-very-visible.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/2-channel-sample-period,mcu-wake-up-clearly-visible.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/3-mcu-at-128-Hz-(CLOCK_SECOND)-wake-up.png\" class=\"alignnone size-full\" />
The mcu wake-up power peaks at 128 Hz. There is not much being done in the background really.

<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/3.5-channel-sample-closeup-18.5-mA-for-4.5-ms.png\" class=\"alignnone size-full\" />
Zoom-in on a channel sample. 18.5 mA for 4.5 ms, as it takes a little while for the crystal to stabilize.

<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/4-unicast-transmission-and-some-channel-samples.png\" class=\"alignnone size-full\" />
A unicast transmission and some channel samples.

<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/5-unicast-transmission-with-CSMA.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/6-broadcast-transmission.png\" class=\"alignnone size-full\" />
A full broadcast transmission.

<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/7-broadcast-with-channel-sample,CSMA-and-then-start-of-transmission.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/8-CSMA-and-start-of-unicast.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/9-unicast,part-of-train-tx,then-listen-2-ms-listen-more-expensive-than-transmit.png\" class=\"alignnone size-full\" />
...
<img src=\"http://www.bithappens.se/resources/pictures/blog/simplerdcpics/oscilloscope/10-tx-with-LED-toggle-to-off-ca-3,7-mA-difference-on-off.png\" class=\"alignnone size-full\" />
