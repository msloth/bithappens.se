...
then set Buffer Listener to monitor ‘Custom pointer’, enter name ‘cooja_debug_string’ and Parser to ‘Terminated string’. Monitoring a variable with Parser ‘Graphical: Grayscale’ is good for seeing how a value changes over execution time.</pre>
